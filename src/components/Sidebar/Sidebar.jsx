  ...
  return (
    <div className="sidebar h-full max-h-full w-full flex flex-col z-10 bg-[var(--sidebar-bg)]">
      ...
      <div className="flex flex-col mb-4">
        ...
        <SidebarItem path="/radio" isPlayable={true}>
          <svg width="24" height="24" viewBox="0 0 24 24">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          {createdPlatlist.length > 0 && (
            <>
              ...
              <nav className="my-4">
                <ul>
                  <li>
                    <PlaylistItem path="/top100" title="test"></PlaylistItem>
                  </li>
                </ul>
              </nav>
            </>
      ...
      <div className="h-[54px] min-h-[54px] border-t border-[--border-primary]">
        <button className="h-full w-full flex items-center gap-3 px-6 text-[--navigation-text] fill-[--navigation-text]">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
