...
function Artist({ item }) {
    ...
    return (
        <div className="w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 flex flex-col items-center">
            ...
            <span className="text-#FFFFFF80 text-xs text-center font-semibold">
                <span>
            ...
            <span className="py-1.5 cursor-pointer px-[19px] leading-[14px] mb-5 mt-[15px] flex outline-none text-center rounded-full border text-white text-xs border-border-color-1 font-medium bg-purple-500 hover:text-[#DADADA] hover:bg-purple-600">
                <span className="mr-1">
